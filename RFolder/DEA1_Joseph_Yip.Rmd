...
The opportunity exsit to explore the US Southeast region as a result of the low beer sku count beer per 10000 capita.  In addition, we can customize the style of beer based on our ABV/IBU heat map tool for your marketing team to incorporate in their innovation plan.
...
```
### 4 Answer.  The bar charts above visually the Top 25 and bottom 25 states for median ABV and IBU.  
...
```
### 6 Answer.  The ABV distribution shows a right skewed distribution with medians centering around 5% ABV.
...
```
### 8 Answer.  Before completing the KNN, we identify the best knn to run to acieved 80% accruacy was knn =5.  We split the data 70/30 to create a train and test dataset to complete a knn=5 analysis.  The accruacy of the results was ~85.89%.  This would suggest the the sytle of the Ales are highly dependent on the ABV and IBU classification since we got a accruacy rate of 85.89%.
